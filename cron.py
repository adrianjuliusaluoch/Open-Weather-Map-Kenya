...
if __name__ == "__main__":
    ...
    # Check Shape of data from API
    print(f"Shape of dataset from OpenWeatherMap API : {all_weather_data.shape}")
    
    # Define the BigQuery table ID
    table_id = 'weatherbot-413406.cloud_storage.openweathermap'
    ...
    sql = (
           'SELECT *'
           'FROM `cloud_storage.openweathermap`'
           )
